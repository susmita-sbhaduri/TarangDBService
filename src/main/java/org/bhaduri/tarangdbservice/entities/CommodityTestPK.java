...
public class CommodityTestPK implements Serializable {
    ...
    public CommodityTestPK() {
    }

    public CommodityTestPK(String scripid, Date lastupdateminute) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CommodityTestPK)) {
            return false;
        }
        CommodityTestPK other = (CommodityTestPK) object;
    ...
    public String toString() {
        return "org.bhaduri.tarangdbservice.entities.CommodityTestPK[ scripid=" + scripid + ", lastupdateminute=" + lastupdateminute + " ]";
    }
